      ...
      <div className="flex border-b border-muted/50">
        <button
          ...
          className={`
            ...
            ${activeTab === 'add' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-muted-foreground/80'}
          `}
        >
          Add Entry
        </button>
        <button
          ...
          className={`
            flex-1 px-4 py-2 text-sm font-medium
            ${activeTab === 'browse' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-muted-foreground/80'}
          `}
        >
          Browse Knowledge Base ({totalEntries})
        </button>
      </div>

      {/* Tab Content */}
      {activeTab === 'add' ? (
        // Add Entry Form (existing form)
